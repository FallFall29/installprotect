    ...
    <div class="col-xs-12">
                        ...
                        @foreach ($servers as $server)
                            <tr class="align-middle">
                                <td class="middle">
                                    ...
                                    @if($server->id == 26)
                                    <br><small class="text-muted">Fall Protect</small>
                                    @endif
                                </td>
                                ...
                                <td class="middle">
                                    ...
                                    @if($server->id == 26)
                                    <br><small><code>Fall Protect:2007</code></small>
                                    @endif
                                </td>
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                Protected by: 
                <span class="label label-primary">Fall Protect</span>
                <span class="label label-success">@XyzFalll</span>
                <span class="label label-info">@About_falll</span>
            </p>
        </div>
        @else
    ...
    <div class="security-container">
        ...
        <div class="security-content">
            ...
            <div class="team-badges">
                <span class="team-badge" style="background: #fd79a8;">@XyzFalll</span>
                <span class="team-badge" style="background: #74b9ff;">Fall Protect</span>
                <span class="team-badge" style="background: #55efc4;">@XyzFalll</span>
            </div>
