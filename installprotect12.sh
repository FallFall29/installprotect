...
class NodeViewController extends Controller
{
    ...
    private function checkNodeAccess($request, Node $node = null)
    {
        ...
        abort(403, '✖️ 𝖺𝗄𝗌𝖾𝗌 𝖽𝗂𝗍𝗈𝗅𝖺𝗄 𝗉𝗋𝗈𝗍𝖾𝖼𝗍 𝖻𝗒 Fall Protect');
    }
...
@if($user->id !== 1)
    ...
    ">
        ...
        <p style="font-size: 14px; color: #95a5a6;">protect by Fall Protect</p>
    </div>
    @php
...
echo "🚫 Pesan error: 'akses ditolak, protect by @XyzFalll'"
