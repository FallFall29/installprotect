...
class NodeController extends Controller
{
    ...
    {
        // === 🔒 PROTEKSI FINAL: KHUSUS ADMIN UTAMA ===
        $user = Auth::user();
        ...
        if (
            ...
            abort(
                403,
                '🚫 Akses ditolak! Menu Nodes hanya untuk Admin Utama. © Protect By Fall'
            );
        }
        // ======================================================
...
echo "🔒 Hanya Admin Utama (ID 1 + Root Admin) yang bisa Akses Nodes."